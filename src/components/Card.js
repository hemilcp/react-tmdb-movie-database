...
class Card extends Component {
	...
	return(
		...
		<div className = "col-xs-12 cardcont nopadding">
			<div className="meta-data-container col-xs-12 col-md-8 push-md-4 col-lg-5 push-lg-5">
				...
				<div className="additional-details" >
					...
					<div className="row nopadding release-details">
						...
						<div className="col-xs-6"> Box-office Revenue: <span className="meta-data"> {data.revenue} </span></div>
						<div className="col-xs-6"> Voting Average: <span className="meta-data"> {data.vote_average} </span></div>
					</div>
				</div>
			</div>
